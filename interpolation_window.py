...
class InterpolationWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.change_color_button = Utils.create_button(f"", self.change_color, "color")
    ...
    def show_statistics(self):
        self.statistics_window = InterpolationStatisticsWindow(self.glued_signal, self.color)
